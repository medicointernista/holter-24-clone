...
const servicesData = [
  {
    ...
    alt: "Dispositivo portátil de monitoreo Holter 24 horas para detección de arritmias cardíacas en Medellín - Dr. Willmer Obregón",
  ...
  },
    {
      ...
      alt: "Electrocardiograma de alta precisión - Estudio cardiovascular en Medellín con el Dr. Willmer Obregón",
    ...
    },
    {
      ...
      alt: "Monitoreo ambulatorio de presión arterial MAPA 24 horas para control de hipertensión - Medellín",
